...
<div class="centra"><span class="notetitulo" style="font-size:1.8em;">Usuários Cadastrados no Sistema</span></div>
<table cellspacing="0" summary="Usuários Cadastrados">
  ...
  <tbody>
	...
	$paginas=$_POST['NRP'];
	$page=$_POST['page'];
	echo "<div id='paginacao'><a href=".BASE_URL."/users/paginado?p=".(1).">Inicio</a></div>"; 
if($page > 1){echo "<div id='paginacao'><a href=".BASE_URL."/users/paginado?p=".($page-1).">Anterior</a></div>"; 
}else {echo "<div id='paginacao'><a href=".BASE_URL."/users/paginado?p=".($page).">Anterior</a></div>"; }
echo "<div id='paginacao'><a class='atual' href='#'>[ ".$page." ] </a></div>";
if($page < $paginas){ echo "<div id='paginacao'><a href=".BASE_URL."/users/paginado?p=".($page+1).">Proxima</a></div>"; 
}else{ echo "<div id='paginacao'><a href=".BASE_URL."/users/paginado?p=".($page).">Proxima</a></div>"; }
$final = ceil($paginas);
echo "<div id='paginacao'><a href=".BASE_URL."/users/paginado?p=".($final).">Final</a></div>";
echo "</div>";
?>
      </td>
    </tr>  
