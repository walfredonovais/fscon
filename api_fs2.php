...
/*
fonte: https://github.com/mevdschee/php-crud-api

comandos:

http://localhost/api.php/categories?transform=1
...
http://localhost/api.php/categories?filter=name,eq,Internet
http://localhost/api.php/categories?filter=name,sw,Inter
http://localhost/api.php/categories?filter=id,le,1
http://localhost/api.php/categories?filter=id,ngt,2
http://localhost/api.php/categories?filter=id,bt,1,1
http://localhost/api.php/categories?filter=categories.id,eq,1
...
$api = new PHP_CRUD_API(array(
 	'dbengine'=>'MySQL',
 	'hostname'=>'localhost',
 	'username'=>'fscon379_fscon',
 	'password'=>'1756piracatu',
 	'database'=>'fscon379_fs',
 	'charset'=>'utf8'
 ));
 $api->executeCommand();
