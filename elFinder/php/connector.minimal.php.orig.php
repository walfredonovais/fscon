...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../../assets/images/clientes/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../assets/images/clientes/', // URL to files (REQUIRED)
		...
		array(
			...
			'driver'        => 'Trash',
			'path'          => '../files/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../../assets/images/clientes/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
